...
An on-going three-year research project funded by ADD, jointly conducted with the Aerospace Propulsion Laboratory (APL) of Seoul National University (SNU). Along with the team led by Professor Jaemyung Ahn and Professor BokJik Lee, I worked on adaptive aerodynamcs prediction upon changes of the shape using deep learning. Under extreme flow conditions, changes in aerodynamic design shape frequently occurs. As a result, we need a fast and accurate technique to predict the chanes in aerodynamic coefficients as a result of shape changes. I worked on the deep learning pipeline for preprocessing raw data and training residual deep neural nets to fine tune the prediction performance. 
...
<figure class="half">
    <img src="/assets/images/AE551_Test_Benchmark.jpg">
